    ...
    return (
        <>
            ...
            <AnimatePresence>
                {showTurnEnd && (
                    <motion.div
                        className="fixed inset-0 flex items-center justify-center z-[100] pointer-events-none overflow-hidden"
                    >
                        <motion.div
                ...
                {showOpponentTurn && (
                    ...
                    >
                        <motion.div
                            ...
                            style={{
                                textShadow: "0 0 30px rgba(255, 100, 100, 0.9), 0 0 60px rgba(255, 50, 50, 0.6), 0 0 90px rgba(255, 0, 0, 0.3)",
