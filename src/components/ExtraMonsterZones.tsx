    ...
    return (
        <div className="mb-2">
            <div className="flex flex-row space-x-2">
                ...
                {/* 左のエクストラモンスターゾーン */}
                <FieldZone className={`${cardSizeClass} border-4 border-red-400`} type={"extra_zone"} hasCard={!!extraMonsterZones[0]}>
                ...
                {/* 右のエクストラモンスターゾーン */}
                <FieldZone className={`${cardSizeClass} border-4 border-red-400`} type={"extra_zone"} hasCard={!!extraMonsterZones[1]}>
                ...
                >
                    <AnimationWrapper initial={opponentFieldInitial}>
                        <Card card={opponentField?.fieldZone || null} />
                    </AnimationWrapper>
                </FieldZone>
            </div>
        </div>
